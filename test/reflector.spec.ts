...
class ClassWithDecorators {
  ...
  constructor(@ParamDecorator('a') a: AType, @ParamDecorator('b') b: AType, d: AType) {
    this.a = a;
    this.b = b;
  }
}
  ...
  describe('Reflector', () => {
    ...
    describe('parameters', () => {
      it('should return an array of parameters for a type', () => {
        ...
        expect(p).toEqual([[AType, new ParamDecorator('a')], [AType, new ParamDecorator('b')], [AType]]);
      });
    ...
    describe('inheritance with decorators', () => {
      it('should inherit annotations', () => {
        ...
        expect(reflector.annotations({} as any)).toEqual([]);
        expect(reflector.annotations(1 as any)).toEqual([]);
      ...
      it('should inherit parameters', () => {
        ...
        expect(reflector.parameters(ChildWithCtorNoDecorator)).toEqual([undefined, undefined, undefined] as any[]);

        expect(reflector.parameters(NoDecorators)).toEqual([]);
        expect(reflector.parameters({} as any)).toEqual([]);
        expect(reflector.parameters(1 as any)).toEqual([]);
      ...
      it('should inherit property metadata', () => {
        ...
        expect(reflector.propMetadata({} as any)).toEqual({});
        expect(reflector.propMetadata(1 as any)).toEqual({});
    ...
    describe('inheritance with tsickle', () => {
      ...
      it('should inherit parameters', () => {
        ...
        class ChildWithCtor extends Parent {
          static ctorParameters = () => [{ type: C, decorators: [{ type: ParamDecorator, args: ['c'] }] }];
          constructor() {
            super();
          }
        }
    ...
    describe('inheritance with es5 API', () => {
      ...
      it('should inherit parameters', () => {
        ...
        class ChildWithCtor extends Parent {
          static parameters = [[C, new ParamDecorator('c')]];
          constructor() {
            super();
          }
        }
